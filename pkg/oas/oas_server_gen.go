...
type Handler interface {
	...
	GetBulkAccountJettonBalances(ctx context.Context, req OptGetBulkAccountJettonBalancesReq, params GetBulkAccountJettonBalancesParams) (*AccountBalances, error)
