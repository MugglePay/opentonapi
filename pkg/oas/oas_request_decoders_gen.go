...
func (s *Server) decodeGetBulkAccountJettonBalancesRequest(r *http.Request) (
	req OptGetBulkAccountJettonBalancesReq,
	close func() error,
	rerr error,
) {
	var closers []func() error
	...
	case ct == "application/json":
		...
		var request OptGetBulkAccountJettonBalancesReq
		if err := func() error {
			request.Reset()
			if err := request.Decode(d); err != nil {
				return err
